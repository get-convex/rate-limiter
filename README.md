...
Resetting or applying a credit to a sharded rate limit will read and write to
all of the shards, which may cause OCC conflicts if there are many concurent
requests. If your use-case involves frequent credits or resets, consider
